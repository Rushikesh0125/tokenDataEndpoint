const ABI =  [
    ...
    {
      "inputs": [],
      "name": "CROSS_CHAIN_STAKE_MESSAGE",
      "outputs": [
        {
          "internalType": "bytes32",
          "name": "",
    ...
    {
      "inputs": [],
      "name": "calculateAndUpdateRewards",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    ...
    },
    {
      ...
      "name": "getCurrentRewardForAddress",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
    ...
    {
      "inputs": [],
      "name": "getNumberOfLocalStakedBuds",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
    ...
    },
    {
      ...
      "name": "setTotalStakedBudsEndpoint",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
